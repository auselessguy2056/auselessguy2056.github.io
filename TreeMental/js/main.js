// This file contains the main game logic, including point calculation, prestige, and research.
...
const FUNCTIONS = {     
    ...
    getRPGain() {
        let gain = E(0); // Initialize gain to 0
        // Add a base research point gain if prestige points are high enough.
        if (player.research.unl == true) {
            gain = gain.add(1);
        }
